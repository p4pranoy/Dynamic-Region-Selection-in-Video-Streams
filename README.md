This repository contains a Python script (Dynamic Region Selection in Video Streams.py) that demonstrates how to dynamically select a region of interest (ROI) in a live video stream using OpenCV.
